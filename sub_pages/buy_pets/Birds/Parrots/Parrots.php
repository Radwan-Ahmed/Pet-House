...
<section class="hero" id="about">
          <img  src="/assets/birds/Parrots.jpg"  alt="Pets"  loading="lazy"  class="hero-img">
        <div class="hero-img">     
        <div class="bio animate__animated animate__shakeX">
          <h2 class="bio-title">Parrots</h2>
          <p class="bio-text">
          <span>Size</span>
          <p> 15-17 inches </p>
          <span>Color</span>
          ...
          <a href="/sub_pages/buy_pets/Birds/Parrots/Parrots_Buy.php"><button class="button">Place order</button></a>
