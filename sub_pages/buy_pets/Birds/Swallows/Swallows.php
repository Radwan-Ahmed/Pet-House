...
<section class="hero" id="about">
          <img  src="/assets/birds/swallows.jpg"  alt="Pets"  loading="lazy"  class="hero-img">
        <div class="hero-img">     
        <div class="bio animate__animated animate__shakeX">
          <h2 class="bio-title"> swallows </h2>
          <p class="bio-text">
          <span>Size</span>
          ...
          <a href="/sub_pages/buy_pets/Birds/Swallows/Swallows_Buy.php"><button class="button">Place order</button></a>
