...
<section class="hero" id="about">
          <img  src="/assets/birds/Toucan.jpg"  alt="Pets"  loading="lazy"  class="hero-img">
        <div class="hero-img">     
        <div class="bio animate__animated animate__shakeX">
          <h2 class="bio-title">Toucan </h2>
          <p class="bio-text">
          <span>Size</span>
          <p> 23 to 25 inch</p>
          <span>Color</span>
          ...
          <a href="/sub_pages/buy_pets/Birds/Toucan/Toucan_Buy.php"><button class="button">Place order</button></a>
