...
<section class="hero" id="about">
          <img  src="/assets/Cats/BurmeseCat.jpg"  alt="Pets"  loading="lazy"  class="hero-img">
        <div class="hero-img">     
        <div class="bio animate__animated animate__shakeX">
          <h2 class="bio-title">Burmese Cat</h2>
          <p class="bio-text">
          <span>Size</span>
          <p> medium-to-large sized cat </p>
          <span>Color</span>
          <p>warm blue, chocolate, blue, lilac</p>
          </p>
          <a href="/sub_pages/buy_pets/Cats/Burmese_Cat/Burmese_Cat_Buy.php"><button class="button">Place order</button></a>
...
<section class="more-about">
  <h2>Temperament</h2>
  <p>
  Sweet Natured, Playful, People-Oriented
  </p>
</section>
<section class="more-about">
  <h2>Health</h2>
