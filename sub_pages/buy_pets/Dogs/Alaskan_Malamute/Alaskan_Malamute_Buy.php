...
<head>
    ...
    <!-- Link our CSS file -->
    <link rel="stylesheet" href="/sub_pages/buy_pets/Dogs/Alaskan_Malamute/Alaskan_Malamute_Buy.css">
        ...
        <div class="container">
            ...
            <form action="/sub_pages/buy_pets/Dogs/Alaskan_Malamute/database.php" method="POST" class="order" oninput="net_price.value=parseFloat(qty.value)*parseFloat(price.value)">
                <fieldset>
                    ...
                    <input type="text" name="id" class="input-responsive" readonly  value="3006">
                    ...
                    <div class="order-label">Age</div>
                       ...
                       <!-- <input name="net_price1" type ="text" value="0" for="qty Name" style="color: white;"></input> -->
                        <output name="net_price" type ="text" value="0" for="qty Name" style="color: white;"></output>
                    </div>
