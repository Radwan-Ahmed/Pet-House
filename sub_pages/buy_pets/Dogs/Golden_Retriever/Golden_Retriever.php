...
<section class="hero" id="about">
          <img  src="/assets/dogs/GoldenRetriever.jpg"  alt="Pets"  loading="lazy"  class="hero-img">
        <div class="hero-img">     
        <div class="bio animate__animated animate__shakeX">
          <h2 class="bio-title">Golden Retriever</h2>
          <p class="bio-text">
          <span>Size</span>
          ...
          <a href="/sub_pages/buy_pets/Dogs/Golden_Retriever/Golden_Retriever_Buy.php"><button class="button">Place order</button></a>
