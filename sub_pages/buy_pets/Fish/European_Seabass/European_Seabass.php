...
<section class="hero" id="about">
          <img  src="/assets/fish/EuropeanSeabass.jpg"  alt="Pets"  loading="lazy"  class="hero-img">
        <div class="hero-img">     
        <div class="bio animate__animated animate__shakeX">
          <h2 class="bio-title"> European Seabass </h2>
          <p class="bio-text">
          <span>Size</span>
          ...
          <a href="/sub_pages/buy_pets/Fish/European_Seabass/European_Seabass_Buy.php"><button class="button">Place order</button></a>
...
<section class="more-about">
        <h2>More about European Seabass</h2>
        <p>
