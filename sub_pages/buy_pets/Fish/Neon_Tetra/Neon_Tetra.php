...
<section class="hero" id="about">
          <img  src="/assets/fish/NeonTetra.jpg"  alt="Pets"  loading="lazy"  class="hero-img">
        <div class="hero-img">     
        <div class="bio animate__animated animate__shakeX">
          <h2 class="bio-title"> Neon Tetra </h2>
          <p class="bio-text">
          <span>Size</span>
          <p> Small</p>
          <span>Color</span>
          <p>Gold Neon, Diamond Neon</p>
          <span>Group</span>
          <p>Freshwater</p>
          <span>Aquarium Siz</span>
          <p> Medium (30 gal)</p>
          </p>
          <a href="/sub_pages/buy_pets/Fish/Neon_Tetra/Neon_Tetra_Buy.php"><button class="button">Place order</button></a>
