            ...
            <form action="/sub_pages/buy_pets/database.php" class="order" oninput="net_price.value=parseFloat(qty.value)*parseFloat(price.value)" method="POST">
                <fieldset>
                    ...
                    <div class="pet-menu-img">
                        <img src="/assets/fish/ZebraFish.jpg" alt="Zebra Fish" class="img-responsive img-curve">
                    </div>
                    ...
                    <input type="text" name="name" class="input-responsive" readonly  value="Zebra Fish">                   
