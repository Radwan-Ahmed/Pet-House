...
<head>
    ...
    <!-- Link our CSS file -->
    <link rel="stylesheet" href="/sub_pages/buy_pets/Snakes/black_rat/black_rat_Buy.css">
...
<nav>
    ...
    <section class="snake-search">
        <div class="container">
            ...
            <form action="/sub_pages/buy_pets/Snakes/black_rat/database.php"  class="order" oninput="net_price.value=parseFloat(qty.value)*parseFloat(price.value)" method="POST">
                <fieldset>
                    <legend style="color: white;" >Selected Snake</legend>

                    <div class="snake-menu-img">
                        <img src="/assets/snakes/black_rat.jpg" alt="black_rat" class="img-responsive img-curve">
                    </div>
                    ...
                    <input type="text" name="name" class="input-responsive" readonly  value="black rat" style="color: black;">
