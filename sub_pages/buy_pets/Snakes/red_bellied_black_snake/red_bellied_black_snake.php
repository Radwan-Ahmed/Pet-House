...
<section class="hero" id="about">
          <img  src="/assets/snakes/red_bellied_black_snake.jpg"  alt="Pets"  loading="lazy"  class="hero-img">
        <div class="hero-img">     
        <div class="bio animate__animated animate__shakeX">
          <h2 class="bio-title"> Red Bellied Black Snake </h2>
          <p class="bio-text">
          <span>Size</span>
          ...
          <a href="/sub_pages/buy_pets/Snakes/red_bellied_black_snake/red_bellied_black_snake_Buy.php"><button class="button">Place order</button></a>
