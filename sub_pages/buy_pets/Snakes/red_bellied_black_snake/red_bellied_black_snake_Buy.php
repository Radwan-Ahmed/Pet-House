...
<head>
    ...
    <!-- Link our CSS file -->
    <link rel="stylesheet" href="/sub_pages/buy_pets/Snakes/red_bellied_black_snake/red_bellied_black_snake_Buy.css">
...
<nav>
    ...
    <section class="snake-search">
        <div class="container">
            ...
            <form action="/sub_pages/buy_pets/Snakes/red_bellied_black_snake/database.php" class="order" oninput="net_price.value=parseFloat(qty.value)*parseFloat(price.value)" method="POST">
                <fieldset>
