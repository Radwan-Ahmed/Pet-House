...
<head>
    ...
    <!-- Link our CSS file -->
    <link rel="stylesheet" href="/sub_pages/buy_pets/Snakes/timber_rattle_snake/timber_rattle_snake_Buy.css">
...
<nav>
    ...
    <section class="snake-search">
        <div class="container">
            ...
            <form action="/sub_pages/buy_pets/Snakes/timber_rattle_snake/database.php" class="order" oninput="net_price.value=parseFloat(qty.value)*parseFloat(price.value)" method="POST">
                <fieldset>
                    <legend>Selected Dog</legend>

                    <div class="snake-menu-img">
                        <img src="/assets/snakes/Timber_rattle_snake.jpg" alt="Timber Rattle Snake" class="img-responsive img-curve">
                    </div>
                    ...
                    <input type="text" name="name" class="input-responsive" readonly  value="Timber Rattle Snake">
