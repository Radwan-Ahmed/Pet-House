...
<nav>
    ...
    <section class="dog-search">
        <div class="container">
            ...
            <form action="#" class="order" oninput="net_price.value=parseFloat(qty.value)*parseFloat(price.value)">
                <fieldset>
                    ...
                    <input type="text" name="id" class="input-responsive" disabled  value="100-01">
                    <div class="order-label">Dog Name</div>
                    <input type="text" name="name" class="input-responsive" disabled  value="German Shepherd">
                    ...
                    <input type="text" name="price" class="input-responsive" disabled  value="400.50">
